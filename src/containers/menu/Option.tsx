...
const Option = ({ 
  ...
  return (<>
    {control.display && <Wrapper title="Paramètres"
                                 show={control.open}
                                 onClose={onToggle}
                                 ref={ref}>
      <OptionLayout>
        <ControlIconBtnWrapper title="Direction de vue">
        ...
        <ControlIconBtnWrapper title="Défilement">
